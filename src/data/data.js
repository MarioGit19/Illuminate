...
export const lampProducts = [
  ...
  },
  {
    ...
    categories: ["Pendant Lights", "Modern"],
    description:
      "Illuminate your home with the sophisticated elegance of this Glass Globe Pendant. Its smooth, spherical design offers a soft, ambient glow that adds an artistic touch to any room. Perfect for modern interiors, this pendant light is an eye-catching statement piece.",
    image: "https://placehold.co/400x300?text=Glass+Globe+Pendant",
  },
  {
    id: 17,
    ...
    categories: ["Floor Lamps", "Industrial"],
    description:
      "Add a touch of industrial flair to your living space with this Copper Floor Lamp. The warm metallic finish and sleek design make it a perfect addition to any contemporary or vintage-inspired home. Its adjustable arm allows you to direct light where you need it most.",
    image: "https://placehold.co/400x300?text=Copper+Floor+Lamp",
  },
  {
    id: 18,
  ...
  },
  {
    ...
    categories: ["Table Lamps", "Modern"],
    description:
      "Bring minimalist charm into your home with the Scandinavian Table Lamp. With its simple design and neutral colors, this lamp creates a calm, soothing atmosphere, perfect for any modern interior. Its sleek structure makes it an ideal desk or bedside companion.",
  ...
  },
  {
    ...
    price: 119.99,
    categories: ["Pendant Lights", "Industrial"],
    description:
      "Add a bold touch to your home with the Industrial Cage Light. The exposed bulb design, paired with a rugged metal cage, brings an edgy, industrial feel to any room. Perfect for modern, loft-style spaces, this light is a must-have for those who appreciate raw design.",
  ...
  },
  {
    ...
    categories: ["Table Lamps", "Modern"],
    description:
      "The Ceramic Table Lamp brings warmth and elegance to any room with its unique ceramic base and soft lighting. Ideal for creating a cozy ambiance, its timeless design will complement both traditional and modern home décor.",
  ...
  },
  {
    ...
    categories: ["Floor Lamps", "Modern"],
    description:
      "Bring a touch of drama to your living space with the Metal Arc Floor Lamp. Its curved arm design provides an expansive reach for brilliant overhead lighting, making it ideal for large rooms, reading corners, or over your favorite chair.",
  ...
  },
  {
    ...
    salePrice: 189.99,
    description:
      "Elegant and timeless, the Crystal Wall Sconce offers sophisticated charm for your hallway, living room, or bedroom. The sparkling crystals catch the light and cast beautiful reflections, creating an atmosphere of refined luxury.",
  ...
  },
  {
    ...
    categories: ["Pendant Lights", "Modern"],
    description:
      "Bring nature indoors with the Rattan Pendant Light. This beautifully woven light adds an earthy, bohemian vibe to your home. Perfect for kitchens, dining areas, or bedrooms, its natural design complements both rustic and modern décor styles.",
  ...
  },
  {
    ...
    price: 139.99,
    categories: ["Desk Lamps", "Vintage"],
    description:
      "The Bronze Desk Lamp features a rich bronze finish and classic design, adding both function and style to your workspace. Its adjustable arm provides versatile lighting for reading or working, while the elegant design suits any desk or office.",
  ...
  },
  {
    ...
    categories: ["Table Lamps", "Vintage"],
    description:
      "The Tiffany Style Table Lamp brings vibrant color and vintage charm to your space. Featuring an intricate glass design, this lamp creates a stunning, multicolored light that adds a unique, artistic touch to any room in your home.",
  ...
  },
  {
    ...
    categories: ["Floor Lamps", "Modern"],
    description:
      "Bring sleek, modern illumination into your home with the Modern LED Floor Lamp. This energy-efficient, stylish light is perfect for any room, offering a contemporary look and providing bright, clear lighting without taking up too much space.",
  ...
  },
  {
    ...
    salePrice: 649.99,
    description:
      "Add an air of sophistication and timeless beauty with the Antique Brass Chandelier. The elegant brass finish and intricate design create a stunning centerpiece for your dining room, living room, or foyer. Its warm glow transforms any space into a luxurious haven.",
...
export const articles = [
  {
    ...
    article_image: "https://placehold.co/400x300?text=Luxury+Home+Design",
    description:
